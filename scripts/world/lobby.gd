...
@export var weapon_chest_scene: PackedScene = preload("res://scenes/world/WeaponChest.tscn")
@export var ground_item_scene: PackedScene = preload("res://scenes/items/GroundItem.tscn")
